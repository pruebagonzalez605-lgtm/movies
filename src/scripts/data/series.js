export const SERIES = [
    ...
    seasons: [
      {
        season: 1,
        episodes: [
          { title: "Sólo di que sí", description: "El intento de Ted de ser expulsado de la escuela secundaria lo lleva a comprar drogas de una fuente no confiable.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS1x1.mp4" },
          { title: "Mis dos padres", description: "El plan de Ted y John para vengarse del bully de la escuela los coloca sin darse cuenta en un papel de padres. Matty acepta hacerse una colonoscopia con una condición.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS1x2.mp4" },
          { title: "Disfunción eyectil", description: "Ted y John llegan a extremos insospechados para que John pueda ver su primera película para adultos.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS1x3.mp4" },
          { title: "Metro, bicicletas y automóviles", description: "Los planes de Ted para Halloween se frustran cuando Blaire lo obliga a ser su conductor designado.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS1x4.mp4" },
          { title: "Desesperadamente buscando a Susan", description: "Blaire les pide a Matty y Susan que le permitan a Ted ser su terapeuta de pareja; Susan sigue una carrera del pasado.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS1x5.mp4" },
          { title: "Noche ruidosa", description: "El deseo poco ortodoxo de Matty para Navidad es concedido, cambiando drásticamente la dinámica de la familia Bennett.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS1x6.mp4" },
          { title: "Tiene que tenerlo", description: "A medida que se acerca el fin del año escolar, Ted conspira para ayudar a John a perder su virginidad.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS1x7.mp4" },
        ],
      },
      {
        season: 2,
        episodes: [
          { title: "Dime cosas obscenas", description: "John y Ted usan un teléfono en el sótano de la escuela para llamar a una línea erótica.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS2x1.mp4" },
          { title: "Sra. Robichek", description: "Ted comienza una arriesgada aventura con una mujer casada, mientras que Matty se enfrenta a problemas de disfunción eréctil.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS2x2.mp4" },
          { title: "Mazmorras y traficantes", description: "John, Ted y Blaire deben completar la campaña de Dungeons and Dragons de un traficante de drogas para conseguir marihuana.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS2x3.mp4" },
          { title: "La comedia romántica de mamá", description: "La maratón de películas románticas de Blaire molesta a Matty. Ted y John tienen una cita doble con su vecina mayor.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS2x4.mp4" },
          { title: "La espada en la piedra", description: "John y Ted hacen una audición para la obra de teatro del colegio. Matty y Susan consiguen trabajos a tiempo parcial en Dunkin' Donuts.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS2x5.mp4" },
          { title: "Roe contra marihuana", description: "Blaire se enfrenta a un embarazo inesperado, lo que provoca reacciones encontradas en la familia.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS2x6.mp4" },
          { title: "Susan es la nueva sensación", description: "Susan asume la culpa por John y Ted cuando un policía encuentra su marihuana durante una parada de tráfico.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS2x7.mp4" },
          { title: "Noticias fraudulentas", description: "John y Ted crean un periódico falso para evitar que Matty se entere del veredicto del caso O.J.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.15/TDS2x8.mp4" },
        ],
      },
    ],
  },
  {
    ...
    tmdbYear: 2022,
    seasons: [
      { season: 1, srcs: ["https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM1X1.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM1X2.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM1X3.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM1X4.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM1X5.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM1X6.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM1X7.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM1X8.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM1X9.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM1X10.mp4"] },
      { season: 2, srcs: ["https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM2X1.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM2X2.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM2X3.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM2X4.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM2X5.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM2X6.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM2X7.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM2X8.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM2X9.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM2X10.mp4"] },
      { season: 3, srcs: ["https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM3X1.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM3X2.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM3X3.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM3X4.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM3X5.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM3X6.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM3X7.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM3X8.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM3X9.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.18/FRM3X10.mp4"] },
  ...
  },
  {
    ...
    seasons: [
      ...
      { season: 2, srcs: ["https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.22/AHS2X1.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.22/AHS2X2.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.22/AHS2X3.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.22/AHS2X4.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.22/AHS2X5.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.22/AHS2X6.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.22/AHS2X7.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.22/AHS2X8.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.22/AHS2X9.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.22/AHS2X10.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.22/AHS2X11.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.22/AHS2X12.mp4", "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.22/AHS2X13.mp4"] },
    ...
    seasons: [
      {
        season: 1,
        episodes: [
          { title: "Episodio 1", description: "Joyce guarda las apariencias en un funeral, pero por dentro carga una historia de rencores y un matrimonio construido sobre secretos.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X1.MP4" },
          { title: "Episodio 2", description: "La llegada de Matipa al entorno de los Gomora empieza a resquebrajar la imagen perfecta que Joyce ha construido para su familia.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X2.MP4" },
          { title: "Episodio 3", description: "Una gran celebración de aniversario obliga a todos a sonreír en público mientras la tensión familiar crece puertas adentro.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X3.MP4" },
          { title: "Episodio 4", description: "El regreso inesperado de Jonasi despierta preguntas en sus hijos y pone a Joyce entre el orgullo y las ganas de recuperar la calma.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X4.MP4" },
          { title: "Episodio 5", description: "Al no obtener lo que buscaba, Matipa decide alejarse del negocio familiar en busca de mejores oportunidades.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X5.MP4" },
          { title: "Episodio 6", description: "Un rumor sobre un posible embarazo altera los ánimos y reaviva viejas sospechas sobre lo que la familia esconde.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X6.MP4" },
          { title: "Episodio 7", description: "El nacimiento de los gemelos desata una crisis emocional en Joyce, mientras los hijos mayores pierden la paciencia con Jonasi.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X7.MP4" },
          { title: "Episodio 8", description: "Ante un escándalo que amenaza con estallar, Joyce plantea una salida drástica que cambiará el rumbo de la familia.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X8.MP4" },
          { title: "Episodio 9", description: "La nueva forma de vida de los Gomora no logra la aceptación que esperaban y cada miembro empieza a sentirse más solo.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X9.MP4" },
          { title: "Episodio 10", description: "Un amor del pasado sale a la luz y revela años de sacrificios y mentiras que Jonasi había mantenido en secreto.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X10.MP4" },
          { title: "Episodio 11", description: "Las revelaciones del episodio anterior obligan a Joyce a replantearse cuánto está dispuesta a perdonar.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X11.MP4" },
          { title: "Episodio 12", description: "Un nuevo conflicto económico pone a prueba la unión entre las esposas de Jonasi.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X12.MP4" },
          { title: "Episodio 13", description: "Viejas rivalidades familiares resurgen justo cuando los Gomora más necesitan mostrarse unidos.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X13.MP4" },
          { title: "Episodio 14", description: "Una decisión de negocios de Jonasi pone en riesgo la estabilidad que la familia había logrado recuperar.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X14.MP4" },
          { title: "Episodio 15", description: "Los hijos de Joyce empiezan a cuestionar abiertamente las decisiones de sus padres.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X15.MP4" },
          { title: "Episodio 16", description: "Un antiguo aliado de Jonasi reaparece con información capaz de desestabilizar todo lo construido.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X16.MP4" },
          { title: "Episodio 17", description: "Joyce enfrenta una decisión que podría costarle su lugar al frente del imperio familiar.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X17.MP4" },
          { title: "Episodio 18", description: "Una traición dentro del propio círculo familiar sale finalmente a la luz.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X18.MP4" },
          { title: "Episodio 19", description: "La salud de Jonasi comienza a resentirse justo cuando la familia atraviesa su momento más frágil.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X19.MP4" },
          { title: "Episodio 20", description: "Tres años después, los Gomora prosperan en apariencia, pero Jonasi regresa convertido en la sombra de lo que fue.", src: "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.23/PLGM1X20.MP4" },
    ...
    seasons: [
      {
        season: 1,
        srcs: [
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB1X3.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB1X2.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB1X1.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB1X4.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB1X5.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB1X6.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB1X7.mp4",
        ]
      },
      {
        season: 2,
        srcs: [
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB2X1.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB2X2.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB2X3.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB2X4.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB2X5.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB2X6.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB2X7.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB2X8.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB2X9.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB2X10.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB2X11.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB2X12.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB2X13.mp4",
        ]
      },
      {
        season: 3,
        srcs: [
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB3X1.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB3X2.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB3X3.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB3X4.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB3X5.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB3X6.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB3X7.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB3X8.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB3X9.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB3X10.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB3X11.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB3X12.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB3X13.mp4",
        ]
      },
      {
        season: 4,
        srcs: [
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB4X1.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB4X2.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB4X3.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB4X4.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB4X5.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB4X6.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB4X7.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB4X8.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB4X9.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB4X10.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB4X11.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB4X12.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB4X13.mp4",
        ]
      },
      {
        season: 5,
        srcs: [
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB5X1.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB5X2.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB5X3.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB5X4.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB5X5.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB5X6.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB5X7.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB5X8.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB5X9.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB5X10.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB5X11.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB5X12.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.31/BKB5X13.mp4",
        ]
      },
    ]
  },
    ...
    seasons: [
      {
        ...
        srcs: [
          ...
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.20/CAS1x11.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.20/CAS1x12.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.20/CAS1x13.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.20/CAS1x14.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.20/CAS1x15.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.20/CAS1x16.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.20/CAS1x17.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.20/CAS1x18.mp4",
          "https://github.com/pruebagonzalez605-lgtm/movies/releases/download/1.20/CAS1x19.mp4",
